...
for i in range(10):
    # 5 simulations varying rayon mobilité (trvael distance) 
    #gui=0 ==> to eliminate interface snapshot ==> number of sample
    # capture_output to to capture both STDOUT and STDERR independently
...
for i in range(10):
    # 5 simulations varying number of vaccinated 
    #gui=0 ==> to eliminate interface snapshot ==> number of sample
    # capture_output to to capture both STDOUT and STDERR independently
...
for i in range(10):
    # 5 simulations varying vaccine_efficiency
    #gui=0 ==> to eliminate interface snapshot ==> number of sample
    # capture_output to to capture both STDOUT and STDERR independently
...
for i in range(20):
    # 10 simulations varying contagion_period
    #gui=0 ==> to eliminate interface snapshot ==> number of sample
    # capture_output to to capture both STDOUT and STDERR independently
...
for i in range(20):
    # 10 simulations varying nb_nodes (density)
    #gui=0 ==> to eliminate interface snapshot ==> number of sample
    # capture_output to to capture both STDOUT and STDERR independently
...
#####################################################################################################
###################### Plusieurs simulations pour chaque ensemble de paramètres #####################
############################################ Multiple ###############################################
#####################################################################################################
